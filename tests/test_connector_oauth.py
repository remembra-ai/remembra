...
class _BridgeClient:
    ...
    async def _request(self, method: str, url: str, json: Any, params: Any, headers: Any) -> httpx.Response:
        merged = {**self._headers, **(headers or {})}
        return await self._http.request(method, url, json=json, params=params, headers=merged)

    def request(self, method: str, url: str, json: Any = None, params: Any = None, headers: Any = None) -> httpx.Response:
        return anyio.from_thread.run(self._request, method, url, json, params, headers)
